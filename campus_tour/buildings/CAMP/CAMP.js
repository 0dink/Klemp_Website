...
function searchAndCreate3(element_ID) {
  ...
  function makefalse1() {
    ...
    var dataArray = JSON.parse(localStorage.getItem('CAMP1_Array'));// Retrieve the array from localStorage
  ...
  function makefalse2() {
    ...
    var dataArray = JSON.parse(localStorage.getItem('CAMP2_Array'));// Retrieve the array from localStorage
  ...
  function makefalse3() {
    ...
    var dataArray = JSON.parse(localStorage.getItem('CAMP3_Array'));// Retrieve the array from localStorage
