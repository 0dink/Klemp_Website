...
function searchAndCreate1(element_ID) {
    ...
    var dataArray = JSON.parse(localStorage.getItem('STB_Array'));
...
function searchAndCreate2(element_ID) {
    // Retrieve the array from localStorage
    var dataArray = JSON.parse(localStorage.getItem('ST1_Array'));
    console.log(dataArray[1])
    // Check if dataArray is not null or undefined
    if (dataArray) {
        // Loop through the array and call createHTMLElementAtCoordinatePair for elements with Display set to true
...
function searchAndCreate3(element_ID) {
    // Retrieve the array from localStorage
    var dataArray = JSON.parse(localStorage.getItem('ST2_Array'));
    console.log(dataArray[1])
    // Check if dataArray is not null or undefined
    if (dataArray) {
        // Loop through the array and call createHTMLElementAtCoordinatePair for elements with Display set to true
...
function makefalse1() {
    ...
    var dataArray = JSON.parse(localStorage.getItem('STB_Array'));// Retrieve the array from localStorage
    ...
    if (dataArray) { // Check if dataArray is not null or undefined
        ...
        localStorage.setItem('STB_Array', JSON.stringify(dataArray)); // Save the updated dataArray back to localStorage
    } else {
        console.log('STB_Array is null or undefined. Please load CSV data first.');
    }
}
function makefalse2() {

    var dataArray = JSON.parse(localStorage.getItem('ST1_Array'));// Retrieve the array from localStorage
    ...
    if (dataArray) { // Check if dataArray is not null or undefined
        ...
        localStorage.setItem('ST1_Array', JSON.stringify(dataArray)); // Save the updated dataArray back to localStorage
    } else {
        console.log('ST1_Array is null or undefined. Please load CSV data first.');
    }
}
function makefalse3() {

    var dataArray = JSON.parse(localStorage.getItem('ST2_Array'));// Retrieve the array from localStorage
    ...
    if (dataArray) { // Check if dataArray is not null or undefined
        ...
        localStorage.setItem('ST2_Array', JSON.stringify(dataArray)); // Save the updated dataArray back to localStorage
    } else {
        console.log('ST2_Array is null or undefined. Please load CSV data first.');
    }
}